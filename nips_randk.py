...
def valid_bert_n_pass_random_with_critic_nips(bert, critic, split = 'val', npass = 3, output_details = False):
...
def valid_trained_in_folder_nips(npass = 3, split = 'test'):
    ...
    for file in matching_files:
        ...
        bert.to(DEVICE)
        bert.eval()
        result = valid_bert_n_pass_random_with_critic_nips(bert, critic, split=split, npass=npass)
